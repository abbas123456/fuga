...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mobile_products_attachment', (
            ...
            ('original_file_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('attachment_file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mobile_products.AttachmentFile'])),
        ))
        ...
        db.create_table(u'mobile_products_ringtone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alternate_genre', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('alternate_subgenre', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ...
            ('country_of_commissioning', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('country_of_recording', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ...
            ('main_subgenre', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('parental_advisory', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('publishing_rights_owner', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('publishing_rights_year', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('recording_location', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ...
            ('rights_holder_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('rights_ownership_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ...
            ('version', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
        ))
        ...
        db.create_table(u'mobile_products_mobileproduct', (
            ...
            ('parental_advisory', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('product_version', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
